export default function Header() {
  return (
    <div className="text-center mb-8 sm:mb-12 md:mb-16 py-8 sm:py-10 md:py-12 border-b-3 border-primary-500 bg-primary-500 text-white -mx-4 sm:-mx-6 lg:-mx-8 -mt-4 sm:-mt-6 lg:-mt-8 relative">
