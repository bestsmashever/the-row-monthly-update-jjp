...
export default function Header({ release }: HeaderProps) {
  return (
    <div className="text-center mb-6 sm:mb-8 md:mb-12 lg:mb-16 py-6 sm:py-8 md:py-10 lg:py-12 border-b-3 border-primary-500 bg-primary-500 text-white -mx-4 sm:-mx-6 lg:-mx-8 -mt-4 sm:-mt-6 lg:-mt-8 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-lg sm:text-xl font-semibold text-white/90 tracking-wide">
          {release.monthLabel} • Version {release.slug}
        </p>
        <div className="text-sm text-white font-normal mt-3 italic flex items-center justify-center gap-2 flex-wrap">
          <span>
            Published {new Date(release.publishedAt).toLocaleDateString(undefined, { year: 'numeric', month: 'short', day: 'numeric' })}
          </span>
