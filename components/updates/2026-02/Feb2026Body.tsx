...
export default function Feb2026Body() {
  return (
    <>
      <InvestmentThesis
        anchors={{
        ...
        delViaSummaryText="Occupancy 18.24% | Leased 24.10%; Market Rent: $2.19/sf | $1,796/unit; Concession: 6-10 weeks free (12.5% to 20.8% off)"
      />
