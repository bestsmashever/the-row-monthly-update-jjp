...
export default function AmazonTransactionsTable() {
  ...
  const debt: Row4Col[] = [
    ...
    { label: 'Bank of Austin', before: '9,000,000', paydown: '(9,000,000)', after: '—' },
  ...
  const common: Row4Col[] = [{ label: 'Common Equity', before: '32,570,001', paydown: '—', after: '32,570,001' }]

  const recon: Row4Col[] = [
    { label: 'Total Capital', before: '97,164,814', paydown: '(38,422,251)', after: '58,742,563' },
