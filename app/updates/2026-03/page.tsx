...
import Mar2026Body from '@/components/updates/2026-03/Mar2026Body'
import SectionNav, {
...
export const metadata: Metadata = {
  title: 'The Row Market Update - Mar 2026',
  description: 'March 2026 Market Intelligence Report',
}

export default function Mar2026UpdatePage() {
  ...
  return (
    <MonthlyUpdateShell
      theme="agora"
      headerTitle="The Row Market Update - Mar 2026"
      sideNav={
        <SectionNav
          sections={sections}
