...
import Jun2026Body from '@/components/updates/2026-06/Jun2026Body'
import SectionNav, {
...
export const metadata: Metadata = {
  title: 'The Row Market Update - June 2026',
  description: 'June 2026 Market Intelligence Report',
}

export default function Jun2026UpdatePage() {
  ...
  return (
    <MonthlyUpdateShell
      theme="agora"
      headerTitle="The Row Market Update - June 2026"
      sideNav={
        <SectionNav
          sections={sections}
