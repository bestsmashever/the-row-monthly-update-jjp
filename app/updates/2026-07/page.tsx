...
import Jul2026Body from '@/components/updates/2026-07/Jul2026Body'
import SectionNav, {
...
export const metadata: Metadata = {
  title: 'The Row Market Update - July 2026',
  description: 'July 2026 Market Intelligence Report',
}

export default function Jul2026UpdatePage() {
  ...
  return (
    <MonthlyUpdateShell
      theme="agora"
      headerTitle="The Row Market Update - July 2026"
      sideNav={
        <SectionNav
          sections={sections}
