...
import Feb2026Body from '@/components/updates/2026-02/Feb2026Body'
import SectionNav, {
...
export const metadata: Metadata = {
  title: 'The Row Monthly Update - Feb 2026',
  description: 'February 2026 Market Intelligence Report',
}
...
export default function Feb2026UpdatePage() {
  ...
  return (
    <MonthlyUpdateShell
      theme="agora"
      headerTitle="The Row Monthly Update - Feb 2026"
      sideNav={
        <SectionNav
          sections={sections}
